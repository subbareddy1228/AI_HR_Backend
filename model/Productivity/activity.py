...
class AppSession(Base):
    ...
    employee = relationship("Employee", back_populates="app_sessions", foreign_keys=[employee_id])
...
class ProductivityActivity(Base):
    ...
    employee = relationship("Employee", back_populates="activities", foreign_keys=[employee_id])