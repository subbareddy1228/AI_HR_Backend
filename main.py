...
app.include_router(ai_interview_router, prefix="/api/ai_interview")
...
app.include_router(admin_candidates_router, prefix="/api/admin/candidates", tags=["Admin Candidates"])
app.include_router(bank_details.router, prefix="/api/onboarding", tags=["Onboarding"])
app.include_router(present_address.router, prefix="/api/onboarding", tags=["Onboarding"])
app.include_router(statutory.router, prefix="/api/onboarding", tags=["Onboarding"])
app.include_router(onboarding.router, prefix="/api/onboarding", tags=["Onboarding"])
app.include_router(approval.router, prefix="/api/onboarding", tags=["Onboarding"])
app.include_router(employee.router, prefix="/api/employees", tags=["Employee Management"])
app.include_router(family_details.router, prefix="/api/employees", tags=["Employee Management"])
app.include_router(documents.router, prefix="/api/employees", tags=["Employee Management"])
app.include_router(personal_info.router, prefix="/api/employees", tags=["Employee Management"])
app.include_router(address.router, prefix="/api/employees", tags=["Employee Management"])

# Company Settings - Currency Management
app.include_router(currency.router, prefix="/api/company-settings", tags=["Company Settings"]) 
app.include_router(financial_year.router, prefix="/api/company-settings", tags=["Company Settings"])
app.include_router(localization.router, prefix="/api/company-settings", tags=["Company Settings"])
app.include_router(policy.router, prefix="/api/company-settings", tags=["Company Settings"])
app.include_router(company_profile.router, prefix="/api/company-settings", tags=["Company Settings"])

#HR Operations - Assets Management
app.include_router(assets.router, prefix="/api/assets", tags=["Assets"])
app.include_router(asset_allocation.router, prefix="/api/assets", tags=["Assets"])
app.include_router(asset_return.router, prefix="/api/assets", tags=["Assets"])
app.include_router(asset_maintenance.router, prefix="/api/assets", tags=["Assets"])
app.include_router(asset_insurance.router, prefix="/api/assets", tags=["Assets"])
