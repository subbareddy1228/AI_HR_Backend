...
from routers.HR_Automation.attendance.routers import shift_management, holiday_calendar, work_hour_rules, attendance_reports as att_rpt, attendance_capture, daily_punches, daily_attendance, manual_attendance, leave_correction
