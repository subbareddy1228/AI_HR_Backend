...
from routers.HR_Automation.attendance.routers import attendance_capture, daily_punches, daily_attendance, shift_management, holiday_calendar, work_hour_rules, attendance_reports as att_rpt
